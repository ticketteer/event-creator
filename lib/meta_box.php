...
class MetaBox {
  ...
  public function init_scripts() {
    wp_register_script( $this->base->plugin_slug . '_admin_js',
    ...
    wp_register_style( 'event_creator_css',
    ...
    wp_register_style( $this->base->plugin_slug . '_admin_css',
  ...
  public function save_meta_box( $post_id, $post ) {
    ...
    do_action( 'sevent_creator_event_saved', $post );
  }
  ...
  public function menu_icon() {
    ?>
    <style type="text/css">#menu-posts-events .wp-menu-image img { width: 16px; height: 16px; }</style>
    <?php
  }
