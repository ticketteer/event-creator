                  ...
                  <div class="event-creator-day-event">
                    ...
                    <div class="event-creator-buy">
                      ...
                      <?php elseif ( $ticketteer_date_id ) : ?>
                        ...
                        <a target="_blank" class="ticketteer-book-btn date-<?= $ticketteer_date_id ?>" data-ticketteer-date-id="<?= $ticketteer_date_id ?>" href="https://shop.ticketteer.com/<?= $slug  ?>/b/<?= $ticketteer_date_id ?>">
                          <?php
