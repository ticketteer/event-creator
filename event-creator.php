...
class EventCreator {
  ...
  public $plugin_slug = 'event-creator';
	...
	public $api_endpoint = 'http://localhost:4000/api';
	public $api_pub_endpoint = 'http://localhost:4000/api';
	public $app_url = 'http://localhost:4220';
	public $book_url = 'http://localhost:3000';

	// public $api_endpoint = 'https://app.ticketteer.com/api/v1';
	// public $api_pub_endpoint = 'https://app.ticketteer.com/api/v1';
	// public $app_url = 'https://app.ticketteer.com';
	// public $book_url = 'https://book.ticketteer.com';
  ...
  function init() {
	...
	function init_settings() {
		...
		if (isset($ticketteer_key) && strlen($ticketteer_key) == 64) {
 ...
 public function common_scripts() {
	 wp_register_style( 'event_creator_common_css',
